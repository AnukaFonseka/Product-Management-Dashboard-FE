...
const Products = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = useGetAllProductsQuery({ category: selectedCategory });


  const rows = products?.payload || [];
  ...
  return (
    <div className="px-32 py-10 bg-scn min-h-screen">
      <h1 className="text-3xl font-bold text-prm mb-6">Products</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Tooltip title="Add New">
              <IconButton
                ...
                size="large"
                className="bg-scn hover:bg-prm text-gray-800 rounded-full shadow-md  focus:outline-none"
              >
                <Add className="" />
              </IconButton>
            </Tooltip>
